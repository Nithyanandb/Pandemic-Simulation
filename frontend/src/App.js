...
import { Chart as ChartJS, ArcElement, LineElement, BarElement, Title, Tooltip,
    Legend, CategoryScale, LinearScale, PointElement} from 
    'chart.js';
...
function App() {
    ...
    //(limit the data to 5 random entries)
